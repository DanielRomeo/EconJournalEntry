...
const PostComponent = ()  => {
    ...
    const handleLoadComplete = (img:any) => {
        const newHeight = img.naturalHeight * (img.clientWidth / img.naturalWidth);
        setHeight(newHeight);
    };
    ...
    return (
        <Card className={`${Styles.card}`}>
            ...
            <Card.Body className={`${Styles.cardBodyPostDetails}`}>
                <Card.Title className={`${Styles.cardBodyPostDetailsTitle}`}>Starting out as a Product designer</Card.Title>
